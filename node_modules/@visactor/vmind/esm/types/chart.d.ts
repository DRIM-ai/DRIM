...
export declare enum mapRegionProjectionType {
    ALBERS = "albers",
...
export declare enum MapRegionCoordinate {
    CARTESIAN = "cartesian",
    POLAR = "polar",
    GEO = "geo"
}
...
export declare const SemiTheme: VMindTheme;
export declare const ArcoTheme: VMindTheme;
export declare const VeOTheme: VMindTheme;
export declare const VeOThemeFinance: VMindTheme;
export declare const VeOThemeGovernment: VMindTheme;
export declare const VeOThemeConsumer: VMindTheme;
export declare const VeOThemeAutomobile: VMindTheme;
export declare const VeOThemeCulturalTourism: VMindTheme;
export declare const VeOThemeMedical: VMindTheme;
export declare const VeOThemeNewEnergy: VMindTheme;
